...
CREATE TABLE IF NOT EXISTS memory_history (
  ...
  CONSTRAINT memory_history_status_check CHECK (status IN ('active', 'superseded', 'deleted', 'expired')),
  CONSTRAINT memory_history_supersedes_fk FOREIGN KEY (supersedes_id) REFERENCES memory_history(id)
);
